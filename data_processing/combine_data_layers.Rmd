...
# NEED TO INCLUDE THE NEW ~2500 SITES HERE WITH THE SAME COLUMNS AS ABOVE
# new_sites <- read.csv(TEMPORARY)
# 
# all_sites <- fqhc_base %>%
#   rbind(new_sites)

all_sites <- fqhc_base # TEMPORARY
```
...
census_api_key('f5b1d1d3e085a5f678d6fe7723ece747f9e4b9f5', install = TRUE, overwrite = TRUE)
